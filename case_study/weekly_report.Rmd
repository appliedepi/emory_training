...
linelist_sf <- linelist %>%
  # remove those missing gps coordinates
  drop_na(lat, lon) %>%
  filter(
...
basemap <- ggplot() +
  ...
  annotation_map_tile(
    ...
    type =  "cartolight",
    ## TODO remove case_study from path at end
    # define folder to store tile images 
    cachedir = here::here("case_study","data", "map_tiles"),
...
basemap + 
  ...
  geom_sf(data = linelist_sf, 
          aes(colour = fct_infreq(eth_race))) + 
