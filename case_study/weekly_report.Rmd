...
zip_counts %>% 
  ...
  add_header_row(
    values = c("", 
               paste0("Recent 14-day reporting period\n", recent_period_labels), 
               "", 
               paste0("Previous 14-day reporting period\n", previous_period_labels), 
               "", 
