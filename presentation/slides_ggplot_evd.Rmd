...
linelist <- import(here::here("case_study", "data", "ebola_example_data", "linelist_cleaned.rds")) %>%
select(case_id, date_onset, outcome, gender, age_years, hospital,
       ht_cm, wt_kg, lon, lat, time_admission, ct_blood, days_onset_hosp)


```

```{r echo=TRUE, eval=FALSE}
linelist <- import(here::here("data", "ebola_example_data", "linelist_cleaned.rds"))
```
...
ggplot(
  data = linelist,
  mapping = aes(x = days_onset_hosp, y = ct_blood)
  )
```
]
