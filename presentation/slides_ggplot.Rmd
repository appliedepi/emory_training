...
# Applied Epi & The Epi R Handbook
...
* We wrote the Epi R Handbook which has been used by 40,000 people worldwide
* Now we want to offer customized training to health departments and NGOs as a non-profit organization
* Our pricing structure will allow us to offer these trainings in low-resource settings  

---
# EDGE  

```{r out.height = "50%", fig.align = "center", echo=F}
knitr::include_graphics(here::here("presentation", "images", "EDGE flow.png"))
```
...
We expect that you have read or at least skimmed the following pages of the Epi R Handbook:  
...
Today we will use a *clean* dataset, as we will focus on techniques for data visualization.  

* Use the `import()` function from **rio** to import an RDS file  
* Use the `here()` function from **here** to locate the file relative to the R project root
