...
```{r, out.width = "80%"}
knitr::include_graphics("https://github.com/appliedepi/emory_training/blob/master/presentation/images/shapefiles.png?raw=true")
```
]
...
knitr::include_graphics("https://github.com/appliedepi/emory_training/blob/master/presentation/images/bounding_box.png?raw=true")
```
]
...
![](https://github.com/appliedepi/emory_training/blob/master/presentation/images/heatmaps.png?raw=true)
