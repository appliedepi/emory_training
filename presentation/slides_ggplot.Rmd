...
* We use `import()` from **rio** because...
* Nesting functions within each other...

```{r import_data}
linelist_raw <- rio::import(here::here("presentation", "data", "linelist_raw.xlsx"))
linelist_clean <- rio::import(here::here("presentation", "data", "linelist_cleaned.rds"))
```
