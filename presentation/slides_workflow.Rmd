...
- Use the `here` package to work with directories [1]
--
...
- Use `rio` to import (most) files [2]
--
...
# use  sheet named **in**
raw_linelist <- rio::import(here::here("data", "covid_linelist.xlsx"), which = "in")
