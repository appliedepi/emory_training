...
* Henry Laurenson-Schafer
 - WHO HQ Covid Analytics. Previously Molecular Biology/Bioinformatics
* Wen Lin 
 - 
...
- See results of tests with `summary()`

.footnote[

[1] [EpiRHandbook section on simple statistics](https://epirhandbook.com/simple-statistical-tests.html?q=stati#simple-statistical-tests)
