...
## **Session 1**: Data cleaning and analytic workflow in R markdown (13^th^ August 2021) {#vids1}
![](https://www.youtube.com/watch?v=nxBTDfJ_neE) 
  
  
## **Session 2**: Data visualization with *ggplot* in R markdowwn (20^th^ August 2021) {#vids2}
